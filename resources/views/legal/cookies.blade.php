...
<section class="relative overflow-hidden">
    ...
    <div class="relative bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
            ...
            <h1 class="text-4xl md:text-5xl font-black text-white mb-3">Política de Cookies</h1>
            ...
            <aside class="lg:col-span-3 hidden lg:block">
                <div class="sticky top-24 bg-white border-2 border-gray-100 rounded-2xl p-5">
                    ...
                    <nav class="space-y-3 text-sm">
                        <a href="#sec-1" class="block text-gray-600 hover:text-purple-600">1. O que são Cookies?</a>
                        <a href="#sec-2" class="block text-gray-600 hover:text-purple-600">2. Como usamos Cookies</a>
                        <a href="#sec-3" class="block text-gray-600 hover:text-purple-600">3. Gerenciamento</a>
                    </nav>
                </div>
            </aside>
            ...
            <div class="lg:col-span-9">
                <div class="bg-white rounded-2xl border-2 border-gray-100 p-6 md:p-10">
                    <div class="prose max-w-none prose-headings:font-bold prose-h2:text-gray-900 prose-p:text-gray-700">
                        <h2 id="sec-1">1. O que são Cookies?</h2>
                        <p>Cookies são pequenos arquivos de texto que ajudam aZendame a funcionar e melhorar sua experiência.</p>

                        <h2 id="sec-2">2. Como usamos Cookies</h2>
                        <p>Usamos cookies para autenticação, preferências, análise e recursos essenciais.</p>

                        <h2 id="sec-3">3. Gerenciamento</h2>
                        <p>Você pode gerenciar cookies no seu navegador. Desativar alguns pode afetar funcionalidades.</p>
                    </div>
                </div>
            </div>
        </div>
