...
@section('page-subtitle', 'Crie uma nova fatura para o evento')

@section('content')
<div class="max-w-4xl mx-auto">
    <form method="POST" action="{{ route('panel.events.invoices.store', $event) }}" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" id="subtotal" name="subtotal" step="0.01" min="0" 
                                   value="{{ $budget ? $budget->subtotal : $event->total_value }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="discount_percentage" name="discount_percentage" step="0.01" min="0" max="100" 
                                       value="{{ $budget ? $budget->discount_percentage : 0 }}"
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="3" 
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">{{ $budget ? 'Fatura baseada no orçamento aprovado.' : '' }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="payment_terms" name="payment_terms" rows="2" 
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">Pagamento à vista ou conforme acordado.</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Datas</h3>
