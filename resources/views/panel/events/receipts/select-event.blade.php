...
@section('title', 'Selecionar Evento - Novo Recibo')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-2">Escolha o evento para criar um novo recibo</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
                        ...
                        @foreach($events as $event)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('panel.events.receipts.create', $event) }}" 
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 mb-4">Você precisa ter eventos cadastrados para criar recibos.</p>
