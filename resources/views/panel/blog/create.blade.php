...
@section('page-title', 'Criar Novo Post')
@section('page-subtitle', 'Crie um novo post para o seu blog')

@section('content')
<div class="max-w-4xl mx-auto">
    <form action="{{ route('panel.blog.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea id="excerpt" 
                              ...
                              rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Breve descrição do post">{{ old('excerpt') }}</textarea>
                    @error('excerpt')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
