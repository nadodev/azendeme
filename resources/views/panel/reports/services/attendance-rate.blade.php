...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">📊 Taxa de Comparecimento</h1>
            <p class="text-gray-600 mt-1">Análise de comparecimento, cancelamentos e no-shows</p>
        </div>
    ...
    <!-- Gráfico de Pizza -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-6">📊 Distribuição dos Agendamentos</h3>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-6">📈 Tendência Mensal de Comparecimento</h3>
        <div class="h-64 flex items-center justify-center">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">📋 Taxa por Serviço</h3>
            <p class="text-sm text-gray-600 mt-1">Comparativo de comparecimento por tipo de serviço</p>
        </div>
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-500">Não há dados de comparecimento para o período selecionado.</p>
            </div>
        @endif
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Gráfico de Pizza - Distribuição dos Agendamentos
    ...
    new Chart(attendanceCtx, {
        type: 'doughnut',
        data: {
            labels: ['Concluídos', 'Cancelados', 'No Show'],
            datasets: [{
                data: [
