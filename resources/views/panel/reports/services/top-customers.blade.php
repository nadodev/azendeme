...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">👥 Clientes Frequentes</h1>
            <p class="text-gray-600 mt-1">Análise dos clientes mais ativos e suas estatísticas</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">🏆 Ranking de Clientes</h3>
            <p class="text-sm text-gray-600 mt-1">Clientes ordenados por número de agendamentos</p>
        </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                            {{ number_format($customer->completed_appointments, 0, ',', '.') }} concluídos
                                        </span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-500">Não há dados de clientes para o período selecionado.</p>
            </div>
        @endif
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500">Taxa Média de Comparecimento</p>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500">Taxa Média de Cancelamento</p>
