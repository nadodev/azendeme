...
<head>
    ...
    <title>{{ $tag->name }} - Blog AzendaMe</title>
    <meta name="description" content="Posts com a tag {{ $tag->name }}">
    ...
    <section class="bg-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="flex items-center justify-center mb-4">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900">{{ $tag->name }}</h1>
            </div>
            <p class="text-xl text-gray-600">Posts marcados com a tag "{{ $tag->name }}"</p>
        </div>
    </section>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">Esta tag ainda não possui posts publicados.</p>
                <div class="mt-6">
